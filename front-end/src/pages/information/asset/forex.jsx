      ...
      <div>
        <div className="light-background2 mb-3 py-2">
          <div className="container-lg">
            <p><Link className="Link"><i class="bi bi-house"></i> Home</Link>  / Assest / forex</p>
          </div>
        </div>
            ...
            <div className="row justify-content-center">
              <div className="col-xl-6 col-lg-8 col-md-10">
                <div className="text-center">
                  ...
                  <div className="pt-4">
                    <Link className="site-btn">Start Trading</Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container-lg">
            ...
            <div className="pt-5">
              ...
              <div className="box-shadow-2 mb-3  py-3 " onClick={toggleStep3}>
                <div className="d-flex justify-content-between font-weight-700  cursor-pointer">
                  <p className="ps-5">  How To Start Trading Forex With CypherBlockSage?  </p>
                  <p className="pe-3"><FontAwesomeIcon icon={faAngleDown}/></p>
                </div>
